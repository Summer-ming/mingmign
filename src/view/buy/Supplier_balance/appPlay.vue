                  ...
                  <TabPane label="余额工程组合" name="name3">
                       ...
                       :footer-method="footerMethod3"  
                        class="vxe-table-element" :highlight-cell='false'  :data.sync="tableDataThree"  >
                         ...
                         <vxe-table-column field="engineeringBo"  title="工程名称|" width="140"></vxe-table-column>
                        </vxe-table>
                    </TabPane>
                </Tabs>
              </Row>
...
findDaoZhangDanAll,
findOrdersAll,findOrgCusAcc,
getUserList,findOrderEngineering,
findOrgMoneyRecordMoneySum} from '@/api/data'
...
//console.log(column.property)
      ...
      // 应收金额 params.row.outMoney2
       ...
       searchM(){ //
         //获取查询的input的值
         let param             = {};
         param.merchantsName  = this.dataSession.orgName  //客户名称
       ...
       searchGroupByEngineering(){
         ...
         let param           = {};
             ...
             param.pageNum   = '1'                                             //分页
             param.orgName   = this.orgName;                                   //公司名称 这是测试传入的信息
             param.pageSize  = "99999";
             param.status    = "1";
    ...
    mounted(){
      this.setInfo();//获取数据，需要先运行
       this.searchM();//table的查询数据
       this.searchDaozhangdan();//查询到账单列表数据
       this.searchGroupByEngineering();//查询根据工程名称拆分的余额数据
