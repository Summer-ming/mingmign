              ...
              <!-- <Table :columns="columnsNew" :data="tableNew"></Table>   -->
               <el-table :data="tableData" style="width: 100%" empty-text='没有数据'>
                 ...
                 <el-table-column prop="kunBaoHao" label="捆包号" width='160' >
                   <template scope="scope">
                     <el-input size="mini" v-model="scope.row.kunBaoHao"  @change='getKun(scope.$index,scope.row)'></el-input>
                   </template>
                 </el-table-column>
                 ...
                 <el-table-column prop="steelGuige" label="规格" width='160'>
                   <template scope="scope">
                       <el-select v-model="scope.row.steelGuige" clearable filterable placeholder="请选择">
                         <el-option
                  ...
                  <el-table-column prop="steelPaihao" label="牌号" width='160'>
                   <template scope="scope">
                       <el-select v-model="scope.row.steelPaihao" clearable filterable placeholder="请选择">
                         <el-option
                 ...
                 <el-table-column prop="warehouse" label="仓库" width='160'>
                  ...
                  <el-table-column prop="jizhongType" label="计重方式" width='160' >
                   <template scope="scope">
                     <el-input size="mini" v-model="scope.row.jizhongType"  ></el-input>
                   </template>
                 </el-table-column>
                ...
                <el-table-column prop="jianShu" label="件数" width='160' >
                 ...
                 <el-table-column prop="weightAll" label="总重" width='160' >
                   <template scope="scope">
                     <el-input size="mini" v-model="scope.row.weightAll"  ></el-input>
                   </template>
                 </el-table-column>
                 ...
                 <el-table-column prop="danjianweight" label="单件重"  width='160'>
                  ...
                  <el-table-column prop="caigouzonge" label="采购总额"  width='160'>
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.caigouzonge"  ></el-input> -->
                ...
                <el-table-column prop="o1OrgId" label="杂费1公司id" width='160' >
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.o1OrgId"  ></el-input> -->
                     {{scope.row.o1OrgId}}
                   </template>
                </el-table-column>
                ...
                <el-table-column prop="o2OrgId" label="杂费2公司id"  width='160' >
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.o2OrgId"  ></el-input> -->
                      {{scope.row.o2OrgId}}
                   </template>
                </el-table-column>
                ...
                <el-table-column prop="o3OrgName" label="选择杂费3公司" width='160'>
                 ...
                 <el-table-column prop="o3OrgId" label="杂费3公司id"  width='160'>
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.o3OrgId"  ></el-input> -->
                      {{scope.row.o3OrgId}}
                   </template>
                </el-table-column>
                ...
                <el-table-column prop="o4OrgName" label="选择杂费4公司" width='160' >
                 ...
                 <el-table-column prop="o4OrgId" label="杂费4公司id" width='160' >
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.o4OrgId"  ></el-input> -->
                      {{scope.row.o4OrgId}}
                   </template>
                </el-table-column>
                ...
                <el-table-column prop="o5OrgName" label="选择杂费5公司" width='160'>
                 ...
                 <el-table-column prop="o5OrgId" label="杂费5公司id"  width='160'>
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.o5OrgId"  ></el-input> -->
                      {{scope.row.o5OrgId}}
                   </template>
                </el-table-column>
                ...
                <el-table-column prop="o6OrgName" label="选择杂费6公司" width='160'>
                 ...
                 <el-table-column prop="o6OrgId" label="杂费6公司id" width='160' >
                   <template scope="scope">
                     <!-- <el-input size="mini" v-model="scope.row.o6OrgId"  ></el-input> -->
                      {{scope.row.o6OrgId}}
                   </template>
                </el-table-column>
...
export default {
  ...
  methods: {
      ...
      getKun(index,row){
        console.log(index)
       this.tableData[index].kunBaoHao=row.kunBaoHao
      },
      //获取分类的值
      getFen(event){
        console.log(event)
  ...
  //totalSum
   computed:{ //计算总金额和总重量
        total(){
            ...
            // this.tableNew.map((item)=>{
            //     console.log('=============1')
            //     item.weightAll += Number(item.weightAll) 
            //     console.log(item.weightAll)
