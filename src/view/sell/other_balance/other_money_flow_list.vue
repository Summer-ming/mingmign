        ...
        <vxe-table height="400" border
         class="mytable-style"
          size="mini" ref="xTable1" :data.sync="data1"  >
                ...
                <vxe-table-column width="150" field="orderNo" title="订单号" ></vxe-table-column>
                <vxe-table-column width="100" :formatter="this.$global.vxeTableMoney" field="outMoney" title="已付金额(元)(入)" ></vxe-table-column>
                <vxe-table-column width="100" :formatter="this.$global.vxeTableMoney" field="inMoney" title="应付金额(元)(出)" ></vxe-table-column>
                <vxe-table-column width="100" :formatter="this.$global.vxeTableMoney" field="dikouMoney" title="优惠金额（元）" ></vxe-table-column>
                <vxe-table-column width="100"   field="key1" title="业务类型" ></vxe-table-column>
                <vxe-table-column width="100"   field="payMoneyType" title="业务类型ID" ></vxe-table-column>
                <vxe-table-column width="140"   field="createTime" title="创建时间" ></vxe-table-column>
                <vxe-table-column width="100"   field="status" title="状态" ></vxe-table-column>
      ...
      getAdmin(item){
       ...
       searchM(){
        ...
        //  param.userId      = this.adminSearchId  //管理员查询
         ...
         param.endTime     = this.formItem.endTime        
          ...
          param.status  = "1";
          param.six = this.$global.pinjieStr("16,17");
          console.log(param);
       ...
       getTotalThisPage(list){//获取当页合计，插入到数据中
          ...
          sList.map(item=>{
                ...
                dic.dikouMoney = this.$global.accAdd(item.dikouMoney,dic.dikouMoney);
          })
          sList.push(dic)
          return sList;
       },
