...
<script>
import {
  findDaoZhangDanAll,deleteDaoZhangDan,findBankLineByBankCode
  } from '@/api/data'
...
import {daozhangdanZhidan_fujian} from '@/api/data_4_8080'
      ...
      if(this.changeformItem.returnBankItem.bankCode==undefined){
        this.$Message.warning('请选择退款银行!');
            ...
            // payType: 40000
                        ...
                        param.memo    = "退款";
                        param.payType = "40000"
                        let url = 'http://10.100.16.4:8080/jg/orders/daozhangdanZhidan'
